<!DOCTYPE html>
        <html lang="en">
            ...
            <body>
                ...
                <section style id="visi-misi" class="py-5 bg-light">
                    <div class="container">
                        <!-- Header Section -->
                        ...
                        <!-- Gambar Sekolah -->
                        <div class="text-center mb-4">
                            <img src="{{ asset('image/vec-school.png')}}" alt="SMK TELKOMUNIKASI TELESANDI BEKASI" class="img-fluid" style="max-width: 300px;">
                        </div>
                        ...
                        <div class=" justify-content-center">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="card border-primary shadow-sm">
                                    ...
                                    <div class="card-body text-primary">
                                        <h5 class="card-title">Menjadi Sekolah Bermutu Unggul</h5>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="card border-primary shadow-sm">
                                    ...
                                    <div class="card-body text-primary">
                                        <h5 class="card-title">Menyelenggarakan Pendidikan Berkualitas</h5>
                                        ...
                                        <ol>
                                            ...
                                            <li>Mengembangkan kurikulum sesuai kompetensi yang diharapkan oleh pengguna lulusan.</li>
                                            <li>Segala aktivitas dilandasi nilai-nilai agama.</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="content-p2db">
                        ...
                        <div class="text-content-p2db">
                            ...
                            <div class="class1">
                                ...
                                <div class="button" >
                                    <a href="https://wa.link/wdzbxl" style="color: white; text-decoration: none;" target="_blank">
                                        Info P2DB
                                    </a>
                                </div>                   
                        ...
                        <hr>
                        <iframe style="border: 1.5px solid black; float: right; margin-left: auto; margin-right: 2.5rem;" src="https://maps.google.com/maps?width=600&amp;height=400&amp;hl=en&amp;q=primago&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed" width="580" height="360" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        <hr>
                ...
                <footer>
                    ...
                    <p>&copy;2024 Created by <span onclick="openLink('https://www.instagram.com/pesantrenleadershipprimago/')">Kelompok Irji</span> (XII RPL 1) || Source from 
                        <span onclick="openLink('https://www.instagram.com/pesantrenleadershipprimago/">Pesantren Leadership Daarut Tarqiyah Primago</span></p>
                </footer>
            </body>
            <script>
